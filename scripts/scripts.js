...
function recalculate() {
    ...
    let cost;
     ...
     if (document.getElementById("model-text") == "Model XYZ") {cost = duration * 100}
     if(document.getElementById("model-text") == "Model CPRG") {cost = duration * 213}
 ...
 //let thing = document.getElementById("model-text");
 ...
 function changeModel() {
    ...
    var modelName = document.getElementById("model-text");
     ...
     if (modelName == "XYZ"){document.getElementById("model-text").innerHTML = "Model CPRG";}
 
     if (modelName == "CPRG"){document.getElementById("model-text").innerHTML = "Model XYZ";}
 ...
 */
 ...
 document.getElementById("duration-text").addEventListener("click", changeDuration);
 
 function changeDuration(){

     //var other = document.getElementById("duration-text");
